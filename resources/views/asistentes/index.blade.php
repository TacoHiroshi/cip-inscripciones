                    ...
                    <form action="{{route('asistentes.store')}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-select mb-3" aria-label="Default select example" name="sexo">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="lug_nacimiento">
                            </div>
                            <div class="col-sm-6">
                                <label for="inputEmail3" class="col-sm-12 col-form-label">Ubicacion Actual</label>
                                <input type="text" class="form-control" name="ubicacion_actual">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-7">
                                <label for="inputEmail3" class="col-sm-12 col-form-label">Centro Laboral Actual</label>
                                <input type="text" class="form-control" name="cent_lab_actual">
                            </div>
                            <div class="col-sm-5">
                                <label for="inputEmail3" class="col-sm-12 col-form-label">Cargo Actual</label>
                                <input type="text" class="form-control" name="cargo_actual">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-4">
                                <label for="inputEmail3" class="col-sm-12 col-form-label">Grado Academico</label>
                                <select class="form-select mb-3" aria-label="Default select example" name="grado_academico">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="num_celular">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="container">
                                    ...
                                    <label class="radio-inline form-check-label">
                                        <input class="form-check-input" type="radio" name="agremiado" value="1" checked>Si
                                    </label>

                                    <label class="radio-inline form-check-label">
                                        <input class="form-check-input" type="radio" name="agremiado" value="2" >No
                                    </label>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="nro_colegiatura">
                            </div>
                        </div>
                        <div class="row mt-6">
                            <div class="col-sm-4">
